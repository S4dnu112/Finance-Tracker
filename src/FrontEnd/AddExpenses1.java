    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            try {
                ...
                Font robotoExtraBold = Font.createFont(Font.TRUETYPE_FONT, new File("Roboto-ExtraBold.ttf")).deriveFont(40f);
                Font interRegular = Font.createFont(Font.TRUETYPE_FONT, new File("Inter-Regular.ttf")).deriveFont(14f);
