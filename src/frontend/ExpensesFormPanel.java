...
// WORKING SUCCESSFULLY ONLY PROBLEM IS FONT, TAPOS SUMMARY

public class ExpensesFormPanel extends JPanel {
    ...
    public ExpensesFormPanel(FinanceBackend fb, Font interRegular, Font robotoExtraBold) {
    ...
    private JPanel createPieChartPanel() {
        ...
        pieChartPanel.setBackground(new Color(196, 218, 210));
        pieChartPanel.setPreferredSize(new Dimension(500, 500));
        pieChartPanel.setBorder(BorderFactory.createLineBorder(new Color(22, 70, 65), 2));
        ...
        pieChartLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 20, 0));
        pieChartPanel.add(pieChartLabel, BorderLayout.SOUTH);
